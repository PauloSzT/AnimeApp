...
import com.example.anime.ui.navigation.NavConstants.CHARACTER_SCREEN_ROUTE
...
sealed class NavItem(var title: String, var icon: Int, var route: String) {
    ...
    object Character : NavItem(CHARACTER_SCREEN_TITLE, R.drawable.ic_character, CHARACTER_SCREEN_ROUTE)
